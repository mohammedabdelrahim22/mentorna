                ...
                <div className="grid gap-4 mx-4 sm:grid-cols-12">
                    ...
                    <div className="relative col-span-12 px-4 space-y-6 sm:col-span-6">
                        <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-700">
                            <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-6 sm:before:h-6 sm:before:rounded-full sm:before:left-[-45px] sm:before:z-[1] before:dark:bg-violet-400">
