        ...
        <div className='brand'>
            <div className="flex justify-center w-full">
                <div className="grid grid_width grid-cols-1 sm:grid-cols-2 md:grid-cols-2 items-center lg:grid-cols-2  sm:w-3/4 lg:w-3/4  md:w-full bg-[#F2F2F2] sm:bg-[#F2F2F2]  brand_padding lg:bg-white pt-[122px] sm:pt-[100px] p-5">
                    <Animated animationIn="bounceInLeft" animationOut="fadeOut" isVisible={true} animationInDuration={5000}>
                        <div className="w-3/5 md:w-2/5 relative ">
                            <h3 className="after_card main_color text-4xl md:text-5xl gothamitalic relative ">
                                Tailored
                                <br />
                                Tactics
                            </h3>
                    ...
                    <Animated animationIn="bounceInRight" animationOut="fadeOut" isVisible={true} animationInDuration={6000}>
                        <div className="mt-[30px] sm:mt[1px] lg:mt-[0px] md:mt-[1px]">
                            <h3 className="text-black text-3xl md:text-4xl gothamitalic ">
                ...
                <div className='cards mt-[40px]'>
                    <div className="mt-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2">
                            <Animated animationIn="bounceIn" animationOut="fadeOut" isVisible={true} animationInDuration={6000}>
                                                    ...
                                                    <div className="text-center pr-2">
                                                        <span className="main_background w-12 h-12 rounded-full flex justify-center items-center text-white">
                                                            <h5 className="sub_font flex justify-center">
                                                                ...
                                                                <img className='object-cover w-[90%]' src={card.icon} />
                                                            </h5>
                                                        </span>
                                                    </div>
                                                </div>
